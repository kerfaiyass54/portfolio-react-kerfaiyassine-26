...
export const Chat: React.FC = () => {
    ...
    const generalBotResponse = async (history) => {
        ...
        try {
            ...
            try {
                ...
                updateHistory("Sorry, I couldn't understand the response.");
                return;
            }

            if (response.status === 429) {
                updateHistory("API rate limit exceeded. Try again later.");
                return;
            }
            ...
            console.error(error);
            updateHistory("Sorry, something went wrong with the bot.");
        }
    };
    ...
    const handleFormSubmit = (e) => {
        ...
        setChatHistory((history) => {
            ...
            setTimeout(() => setChatHistory((prev) => [...prev, { role: "model", text: "Thinking..." }]), 600);
            generalBotResponse(newHistory);
            return newHistory;
        });
    }
            ...
            <div className="chatbot-popup">
                <div className="chat-header">
                    <div className="header-info">
                        ...
                        <h2 className="logo-text">Chat with me</h2>
                    </div>
                </div>
